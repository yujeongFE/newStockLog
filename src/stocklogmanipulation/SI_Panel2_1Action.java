    ...
    private static void addDataToDataset(DefaultCategoryDataset dataset, String stockName) {
        ...
        try (FileInputStream file = new FileInputStream(excelFilePath);
            ...
            if (targetRow != -1) {
                ...
                double value6 = getNumericCellValue(sheet, targetRow, 6);
                double value9 = getNumericCellValue(sheet, targetRow, 9);

                // 데이터셋에 추가
                dataset.addValue(value5, "Price", "Standard Price");
                dataset.addValue(value6, "Price", "Opening Price");
                dataset.addValue(value9, "Price", "Closing Price");
            } else {
